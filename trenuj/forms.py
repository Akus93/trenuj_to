...
class SignupForm(forms.ModelForm):
    ...
    username = forms.CharField(label='Nazwa użytkownika', max_length=30, required=True)
    password1 = forms.CharField(label='Hasło', required=True, widget=forms.PasswordInput)
    password2 = forms.CharField(label='Powtórz hasło', required=True, widget=forms.PasswordInput)
    email = forms.EmailField(label='Nazwa użytkownika', required=True)
