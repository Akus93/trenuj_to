"""
Django settings for trenuj_to project.
...
SECRET_KEY = 'u7sm^g1=_i7(i!8@yc$_wbyundpd8*j7ljnl5*w=@8o$q%blt0'
...
WSGI_APPLICATION = 'trenuj_to.wsgi.application'
